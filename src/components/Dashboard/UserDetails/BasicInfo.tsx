...
const BasicInfo = () => {
  ...
  // console.log((userDetails as keyable).profile.lastName);
            ...
            {loading ? (
              ...
              <>
                {userDetails.map((detail, index) => (
                  <div key={detail.id} className="info-container">
                    <div className="info-wrapper">
                      <div className="avatar">
                        <img src={detail.profile.avatar} alt="user's avatar" />
                      ...
                      <div className="name-wrapper">
                        ...
                        <p className="account-number">{detail.accountNumber}</p>
                      </div>
                    </div>
                    <div className="tier">
                    ...
                    <div className="bank">
                      <h2 className="amount">₦{detail.accountBalance}</h2>
                      <p className="bank-info">
                        {detail.profile.bvn}/{detail.profile.address}
                      </p>
                    </div>
                  </div>
                ))}
